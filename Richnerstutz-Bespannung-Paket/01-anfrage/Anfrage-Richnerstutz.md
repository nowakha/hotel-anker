...
**Status:** **Ware angekommen — Material beanstandet** (Stand 2026-08-04 ~15:48 CEST). Job **SEG (627 828)**.
...
- **Lieferung + Material-Reklamation Harald outbound 2026-08-04 ~15:48** — Print angekommen; Grundmaterial **komplett lichtundurchlässig/schwarz** (Opera-Folie-Vergleich); sofort Nacharbeit auf richtigem Backlit-Untergrund. Msg `19fcd089dbb2ade6` / Thread `19fac62d97c94e3d`. Entwurf: [`Mail-Entwurf-Material-Nacharbeit-2026-08-04.md`](./Mail-Entwurf-Material-Nacharbeit-2026-08-04.md).
...
**Offen:** Druckerei-Antwort zur Material-Reklamation; Remake auf **Lumina / hinterleuchtbares SEG-Textil** mit selektivem Blockout (Opazitätsplatte); Kosten/Termin. Pixelung Gebäude war bewusst akzeptiert. **Kein weiterer Outbound ohne Harald-Go.**
