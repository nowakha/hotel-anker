...
**Status (2026-08-06):** Job **SEG (627 828)** — Ware reklamiert (kein Durchlicht). Tanja Jelk: Musterstück Druck ~**07.08. Mittag**, Unsicherheit Screen vs. Leuchtkasten. Harald hat Geometrie/Material (~15:53) geklärt (Kendu Flowbox, ~4,5 cm Abstand). **Warten auf Muster-Ergebnis + Harald-Go** für weiteres Outbound.
