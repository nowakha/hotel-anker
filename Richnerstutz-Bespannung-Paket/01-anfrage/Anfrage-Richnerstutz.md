...
**Status:** **Ware angekommen — Material beanstandet** (Stand 2026-08-04 ~15:47 CEST). Job **SEG (627 828)**.
...
- Finale Daten 2026-07-27 → Vorstufen-Runden 2026-07-28 (CMYK, Bleed, Blocker, Pixelung) → Korrektur #2 ~17:34.
- **Gut zum Druck** Melanie Vogt 2026-07-29 ~07:39: Qualitäts-Screenshot; **Gebäude noch verpixelt**; wartet auf Bescheid.
- **Druckfreigabe outbound Harald 2026-07-29 ~14:01** — „Sehr gut so“, zeitnah produzieren, Versand an Realia AG / Gottlieb Kündig, Industriestrasse 40b, 9400 Rorschach. Msg `19fadc031b2a6de9` / Thread `19fac62d97c94e3d`. Meta: [`MAIL-FREIGABE-META.md`](./MAIL-FREIGABE-META.md).
- **Produktionsbestätigung Melanie Vogt 2026-07-29 ~14:04** — GO + Lieferadresse erhalten; Produktion startet sofort. Msg `19fadc335e9acd33` / Thread `19fac62d97c94e3d`.
- **Lieferung + Material-Kritik Harald outbound 2026-08-04 ~15:47** — Print angekommen; Dank für Tempo; Grundmaterial wirkt **komplett lichtundurchlässig und schwarz**; Frage nach Opera-/Rückpro-Folie; Satz bricht bei „Da muss wohl sofotrt“ ab. Msg `19fcd079537beb1c` / Thread `19fac62d97c94e3d`. Meta: [`MAIL-MATERIAL-META.md`](./MAIL-MATERIAL-META.md). Entwurf: [`Mail-Entwurf-Material-Reklamation-2026-08-04.md`](./Mail-Entwurf-Material-Reklamation-2026-08-04.md).
...
**Offen / kritisch:** Material passt nicht zu Backlit (Lumina + Multilayer / selektive Transluzenz). Nacharbeit oder Neuproduktion klären. Gmail prüfen: Entwurf vs. bereits gesendet (Body abgebrochen). **Kein weiterer Outbound ohne Harald-Go.**
