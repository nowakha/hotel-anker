...
Stand: **2026-08-04 ~15:48 CEST** — Richnerstutz SEG (627 828): **Ware angekommen**, Material falsch (wirkt komplett lichtundurchlässig/schwarz). Harald-Outbound-Reklamation gesendet. Warte auf Druckerei-Antwort / Nacharbeit. Kein weiterer Outbound ohne Harald-Go.
...
- **Status damals:** Produktion gestartet; wartete auf Liefer-/Versandtermin.

## Richnerstutz — Lieferung + Material-Reklamation Harald outbound (2026-08-04 ~15:48 CEST)

- **Webhook:** `from: harald.nowak@modernlight.ch` — **kein** Richnerstutz-Reply (eigene Outbound-Mail / Zapier-Echo).
- **Betreff:** `Re: Modernlight Production AG, Hotel Anker Rorschach - SEG (627 828)`
- **Gmail:** message_id `19fcd089dbb2ade6` · thread `19fac62d97c94e3d` · date Tue, 4 Aug 2026 15:48:40 +0200
- **Inhalt (Harald → Richnerstutz):** Print heute angekommen; Danke für schnelle Bearbeitung; **Grundmaterial wirkt komplett lichtundurchlässig (und schwarz)** — Vergleich Opera-Folie/Rückpro; **sofort Nacharbeit auf richtigem Untergrund** nötig; Frage ob Einsatzzweck falsch kommuniziert oder Produktionsfehler.
- Früherer Zapier-Hit (~15:45, msg `19fcd05a76a1396e`) hatte Body abgebrochen bei „wirkt komp…“ — dieser Hit = voller Wortlaut.
- **Soll-Material (Anfrage/Offerte):** hinterleuchtetes SEG-Textil, gemischte Opazität (transluzent + selektiver Blockout); Offerte AG 461414 = **Lumina + Multilayer** — **nicht** flächig opakes/schwarzes Blockout-Gewebe.
- **Risiko:** LED-Countdown unbrauchbar bis Remake; Zeitdruck Baubeginn 1.10.2026; Kosten/Schuldfrage offen.
- **Status:** Ware da, Material beanstandet, Reklamation outbound. **STOP** — warte Druckerei-Antwort; kein weiterer Outbound ohne Harald-Go.
- Meta: `Richnerstutz-Bespannung-Paket/01-anfrage/MAIL-FREIGABE-META.md`
- Entwurf Nacharbeit: `01-anfrage/Mail-Entwurf-Material-Nacharbeit-2026-08-04.md`
